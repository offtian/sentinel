...
class TestEvaluationMetrics:
    ...
    def test_token_cost_usd_defaults_to_zero(self) -> None:
        # Given an EvaluationMetrics instance created without specifying token_cost_usd
        # When EvaluationMetrics is created with all required fields but no token_cost_usd
        result = metrics.EvaluationMetrics(
            factual_precision=0.85,
            factual_recall=0.78,
            hallucination_rate=0.05,
        ...
        # Then token_cost_usd defaults to 0.0
