...
class TestBuildKubernetesToolset:
    def test_returns_toolset_with_none_client(self) -> None:
        ...
        toolset = k8s_toolsets.build_kubernetes_toolset(k8s_client=None, namespace="production")
    ...
    def test_builds_with_custom_namespace(self) -> None:
        ...
        # When building the toolset
        toolset = k8s_toolsets.build_kubernetes_toolset(k8s_client=None, namespace="payments")
